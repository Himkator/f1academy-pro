...
<head>
    ...
    <title>F1 Academy – Manager Profile</title>
</head>
<body>
    ...
    <div class="row g-4">
        <div class="col-md-5">
            <div class="card bg-dark border-secondary p-4">
                ...
                <form method="POST" action="/manager/profile/update">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="col-md-7">
            <div class="card bg-dark border-secondary p-4">
                <h5 class="text-white mb-3">📚 Assigned Courses</h5>
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom border-secondary pb-2 mb-2">
                    ...
                    <a href="/manager/courses/{{ $course->id }}" class="btn btn-outline-light btn-sm">Details</a>
                </div>
                @empty
                <p class="text-secondary">No courses assigned yet.</p>
                @endforelse
            </div>
        </div>
    </div>
